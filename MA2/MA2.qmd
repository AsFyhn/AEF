...
```
 ...
 Low momentum stocks offer a negative alpha whereas high momemtum stocks offer a positive alpha. This is not consistent with the CAPM theory and represents an imperfection in the market. In the following, we test if we can exploit this imperfection with a momentum strategy that goes long past winners and short past losers.