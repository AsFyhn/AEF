...
df_rep = pd.DataFrame({
    'Naive': [mmr_ni,var_ni,sharpe_ratio(mmr_ni,var_ni)],
    'Efficient': [mmr_eff,var_eff,sharpe_ratio(mmr_eff,var_eff)],
    'Ex1': [mmr_opt,var_opt,sharpe_ratio(mmr_opt,var_opt)],
    'Ex2': [mmr_pp,var_pp,sharpe_ratio(mmr_pp,var_pp)]
