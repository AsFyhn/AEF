...
As the number of simulations increases (i.e., larger sample size), the simulated frontiers tend to cluster closer to the true efficient frontier. This observation aligns with the reduction in sampling error with increasing sample size.
